...
import UserPlaylistsScreen from '../screens/privatescreens/UserPlaylistsScreen';
...
import MoodDetailScreen from '../screens/privatescreens/MoodDetailScreen';
...
const AppNavigation = () => {
    ...
    const initialRoute = wasLoggedIn.current
        ? 'Login'
        : 'Splash';
    return (
        <View style={{ flex: 1 }}>
            {
                isLoggedIn
                    ?
                    <LoggedInNavigator key="loggedIn" />
                    :
                    <AuthNavigator
                        key="auth"
